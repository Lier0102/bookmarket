...
public class BookCreateRequest {
    @NotBlank(message = "도서 ID를 입력하세요.")
    @Pattern(regexp = "ISBN[0-9]+", message = "도서 ID는 'ISBN'으로 시작하고 뒤에 숫자가 있어야 합니다.")
    @Schema(description = "도서 ID (ISBN 형식, 예: ISBN1234)", example = "ISBN1234")
